...
{
    //Gost
    public static final ASN1ObjectIdentifier ИНН = (new ASN1ObjectIdentifier("1.2.643.3.131.1.1")).intern();
    public static final ASN1ObjectIdentifier ОГРН = (new ASN1ObjectIdentifier("1.2.643.100.1")).intern();
    public static final ASN1ObjectIdentifier СНИЛС = (new ASN1ObjectIdentifier("1.2.643.100.3")).intern();
    public static final ASN1ObjectIdentifier ОГРНИП = (new ASN1ObjectIdentifier("1.2.643.100.5")).intern();
    ...
    {
        //Gost
        DefaultSymbols.put(ИНН,"ИНН");
        DefaultSymbols.put(ОГРН,"ОГРН");
        DefaultSymbols.put(СНИЛС,"СНИЛС");
        DefaultSymbols.put(ОГРНИП,"ОГРНИП");
        ...
        DefaultLookUp.put("огрнип", ОГРНИП);
     ...
     * Singleton instance.
     */
    public static final X500NameStyle INSTANCE = new CustomBCStyle();
    ...
    protected ASN1Encodable encodeStringValue(ASN1ObjectIdentifier oid,
        ...
        //Gost
        else if (oid.equals(ИНН) ||oid.equals(ОГРН)||oid.equals(СНИЛС)||oid.equals(ОГРНИП))
        {
