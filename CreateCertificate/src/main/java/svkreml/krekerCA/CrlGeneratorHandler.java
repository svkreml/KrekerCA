...
public class CrlGeneratorHandler {
    ...
    DatePicker timeOfLife = new DatePicker(LocalDate.now().plus(5, ChronoUnit.DAYS));
    ...
    public void generate() throws Exception {
        ...
        GeneralName generalName = new GeneralName(X500Name.getInstance(CustomBCStyle.INSTANCE, caCert.getSubjectX500Principal().getEncoded()));
        ...
        File file = new File(output.getAbsoluteFile() + ".crl");
        file.getParentFile().mkdirs();
        FileManager.write(file, converter.getCRL(crlHolder).getEncoded());
    }
